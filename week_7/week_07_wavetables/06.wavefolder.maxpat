...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 390.0, 242.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 87.5, 392.0, 38.0, 22.0 ],
					"text" : "*~ -1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 319.0, 301.0, 150.0, 20.0 ],
					"text" : "number~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 252.0, 296.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 252.0, 255.0, 36.0, 22.0 ],
					"text" : "!/~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 252.0, 200.0, 45.0, 22.0 ],
					"text" : "$1 150"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 252.0, 229.0, 48.0, 22.0 ],
					"text" : "line~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 252.0, 145.0, 147.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 252.0, 20.0, 150.0, 60.0 ],
					"text" : "live.dial \nunit style: float\nrange/enum: 0. 999.\nexponent: 0.25"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 252.0, 90.0, 41.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 22.0, 465.0, 29.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 22.0, 520.0, 48.0, 136.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 80.75, 672.0, 48.0, 22.0 ],
					"text" : "s~ out2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 672.0, 48.0, 22.0 ],
					"text" : "s~ out1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 22.0, 419.0, 150.0, 22.0 ],
					"text" : "pong~ 0 0. 0.8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 22.0, 24.0, 74.0, 22.0 ],
					"text" : "receive~ in1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 680.370370370370438, 0.0, 367.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 680.370370370370438, 42.0, 331.370370370370438, 156.052325581395394 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 261.5, 252.0, 97.0, 252.0 ],
					"order" : 2,
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 2 ],
					"midpoints" : [ 261.5, 252.0, 162.5, 252.0 ],
					"order" : 1,
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 261.5, 279.0, 245.0, 279.0, 245.0, 459.0, 42.0, 459.0 ],
					"order" : 1,
					"source" : [ "obj-17", 0 ]
				}
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Desktop/Studio methods/_Classes/sound-synth-tech-SS24/week_7/week_07_wavetables",
				"patcherrelativepath" : ".",
				"type" : "PNG",
				"implicit" : 1
			}
