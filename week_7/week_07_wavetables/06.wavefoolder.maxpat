...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 303.5, 361.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 303.5, 313.0, 40.0, 22.0 ],
					"text" : "!/~ -1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 129.5, 250.0, 38.0, 22.0 ],
					"text" : "*~ -1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 303.5, 257.0, 48.0, 22.0 ],
					"text" : "line~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 303.5, 223.0, 45.0, 22.0 ],
					"text" : "$1 150"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 303.5, 180.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 303.5, 140.0, 134.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 349.0, 54.0, 150.0, 20.0 ],
					"text" : "<live.dial>"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 303.5, 40.0, 41.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 96.0, 420.0, 48.0, 136.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 247.5, 619.0, 48.0, 22.0 ],
					"text" : "s~ out2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 96.0, 619.0, 48.0, 22.0 ],
					"text" : "s~ out1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 579.370370370370438, 39.0, 367.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 597.185185185185219, 81.973837209302303, 331.370370370370438, 156.052325581395394 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 96.0, 290.0, 86.0, 22.0 ],
					"text" : "pong~ 0 0. 0.8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 96.0, 60.0, 74.0, 22.0 ],
					"text" : "receive~ in1"
				}
